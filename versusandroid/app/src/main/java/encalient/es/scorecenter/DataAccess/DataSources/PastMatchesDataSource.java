 ...
 */
public class PastMatchesDataSource extends  DataSource<ProtoSeasonDTO.SeasonDTO>{

    public static final String TABLE_NAME = "pastMatches";
    ...
    public PastMatchesDataSource(SQLiteDatabase database){
        super(database);
    }
