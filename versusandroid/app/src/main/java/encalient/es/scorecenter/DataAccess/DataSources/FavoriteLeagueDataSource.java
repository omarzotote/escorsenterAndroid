 ...
 */
public class FavoriteLeagueDataSource extends  DataSource<ProtoLeagueDTO.LeagueDTO>{

    public static final String TABLE_NAME = "favoriteLeague";
    ...
    public FavoriteLeagueDataSource(SQLiteDatabase database){
        super(database);
    }
