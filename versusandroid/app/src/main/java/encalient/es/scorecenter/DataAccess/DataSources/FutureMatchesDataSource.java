 ...
 */
public class FutureMatchesDataSource extends  DataSource<ProtoSeasonDTO.SeasonDTO>{

    public static final String TABLE_NAME = "futureMatches";
    ...
    public FutureMatchesDataSource(SQLiteDatabase database){
        super(database);
    }
